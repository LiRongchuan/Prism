...
class TpModelWorkerClient:
    ...
    def __init__(
        ...
        if server_args.enable_worker_pool:
            worker_class = WorkerPoolTPWorker
        else:
            worker_class = SingleModelTPWorker
    ...
    def get_memory_usage(self):
        return self.worker.get_memory_usage()
    ...
    def deactivate_model_runner(self):
        self.worker.deactivate_model_runner()

    def activate_model_runner(self, memory_pool_size, gpu_id, model_name):
        self.worker.activate_model_runner(
    ...
    def resize_memory_pool(self, new_memory_pool_size: Optional[float] = None):
        return self.worker.resize_memory_pool(new_memory_pool_size)
